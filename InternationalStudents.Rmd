...
```{r FromTWNCountryBar, message=FALSE, warning=FALSE}
...
```{r FromTWNCountryMap, message=FALSE, warning=FALSE}
...
### 台灣學生最喜歡去哪些國家留學呢？
```{r FromTWNAb, message=FALSE, warning=FALSE}
...
### 台灣學生最喜歡去哪些國家留學面量圖
```{r FromTWNAbMap, message=FALSE, warning=FALSE}
...
## 綜合分析
```{r FromALL, message=FALSE, warning=FALSE}
...
```{r FromALL_2, message=FALSE, warning=FALSE}
library(tidyr)
DATA2 <- head(DATA1,20)
